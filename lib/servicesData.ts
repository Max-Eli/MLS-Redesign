...
export const servicesData: ServicePageData[] = [
  ...
  },
  {
    slug:     'prf',
    name:     'PRF',
    tagline:  'The next evolution of PRP — richer in growth factors, longer lasting results',
    category: 'Injectables',
    categorySlug: 'injectables',
    image:    '/injectables.png',
    overview: 'Platelet-Rich Fibrin (PRF) is the next generation of platelet therapy. Using a slower, lower-speed centrifuge than traditional PRP, PRF retains a higher concentration of platelets, white blood cells, and fibrin — creating a powerful growth factor matrix that releases slowly over time for superior, longer-lasting results. PRF is used for skin rejuvenation, under-eye hollows, hair restoration, and overall facial revitalization.',
    benefits: [
      'Higher concentration of growth factors than traditional PRP',
      'Slow-release fibrin matrix prolongs results',
      'Stimulates collagen, elastin, and new tissue regeneration',
      '100% natural — derived entirely from your own blood',
      'No risk of allergic reaction or rejection',
      'Effective for face, under-eyes, neck, and scalp',
    ],
    howItWorks: [
      { step: 'Blood Draw', description: 'A small amount of blood is drawn — comparable to a routine lab test.' },
      { step: 'Centrifuge', description: 'Blood is spun at a lower speed than PRP, preserving the fibrin scaffold and yielding a richer platelet concentrate.' },
      { step: 'Preparation', description: 'The resulting PRF layer is carefully extracted and prepared for injection.' },
      { step: 'Injection', description: 'PRF is injected into targeted areas using fine needles, releasing growth factors gradually over several weeks.' },
      { step: 'Regeneration', description: 'Growth factors stimulate cellular repair, collagen production, and tissue remodeling for progressive, natural-looking improvement.' },
    ],
    whoIsItFor: 'PRF is ideal for clients seeking a natural, needle-based approach to skin rejuvenation, hair loss, or facial volume restoration. It is particularly effective for the delicate under-eye area and clients who want to avoid synthetic fillers.',
    faqs: [
      { question: 'How is PRF different from PRP?', answer: 'PRF uses a slower centrifuge speed, which preserves the fibrin network and retains more growth factors. The fibrin matrix allows for a slower, sustained release — giving longer-lasting results than PRP.' },
      { question: 'How many sessions do I need?', answer: '3 sessions spaced 4–6 weeks apart is the recommended protocol, followed by annual maintenance.' },
      { question: 'When will I see results?', answer: 'Initial improvement is visible within 2–4 weeks. Full collagen remodeling continues over 3–6 months.' },
      { question: 'Is there downtime?', answer: 'Mild redness and swelling at injection sites for 24–48 hours is normal. Most clients return to normal activities the same day.' },
    ],
  },
  {
    slug:     'prf-ezgel',
    name:     'PRF EZGel',
    tagline:  'A 100% natural bio-filler made from your own blood',
    category: 'Injectables',
    categorySlug: 'injectables',
    image:    '/injectables.png',
    overview: 'PRF EZGel is a revolutionary advancement in regenerative aesthetics. By gently heating PRF, the proteins in the plasma denature and form a cohesive, injectable gel — a completely natural bio-filler created entirely from your own blood. EZGel can be used to restore volume, fill fine lines, and treat delicate areas like the under-eyes, all while simultaneously delivering a high concentration of growth factors for tissue regeneration.',
    benefits: [
      '100% natural bio-filler — no synthetic ingredients',
      'Restores volume while delivering regenerative growth factors',
      'Ideal for the under-eye area, fine lines, and hollow areas',
      'Zero risk of allergic reaction or foreign body response',
      'Combines the volumizing effect of filler with the regenerative power of PRF',
      'Results improve over time as collagen is stimulated',
    ],
    howItWorks: [
      { step: 'Blood Draw', description: 'A small amount of blood is collected and processed using the PRF centrifuge protocol.' },
      { step: 'PRF Extraction', description: 'The platelet-rich fibrin layer is separated and extracted from the sample.' },
      { step: 'Gel Formation', description: 'The PRF is gently heated, causing the plasma proteins to denature and form a smooth, cohesive gel.' },
      { step: 'Injection', description: 'The EZGel is injected into target areas — acting simultaneously as a volumizer and a growth factor delivery system.' },
      { step: 'Remodeling', description: 'Over the following weeks, the body absorbs the gel while the released growth factors stimulate collagen and new tissue formation.' },
    ],
    whoIsItFor: 'PRF EZGel is perfect for clients who want natural volume restoration without synthetic fillers. It is especially popular for the under-eye hollows (tear troughs), fine perioral lines, and areas where a gentle, biocompatible filler is preferred.',
    faqs: [
      { question: 'How is EZGel different from regular PRF?', answer: 'EZGel takes PRF one step further — by heating it, the proteins form a gel that provides immediate volume in addition to releasing growth factors. It functions like a natural filler.' },
      { question: 'How long do results last?', answer: 'Results typically last 6–12 months as the gel is gradually absorbed. The regenerative effects on collagen continue beyond that.' },
      { question: 'Is it safe under the eyes?', answer: 'Yes — because EZGel is made from your own blood, it carries no risk of allergic reaction or vascular complications associated with synthetic fillers in that area.' },
      { question: 'How many treatments are recommended?', answer: 'Most clients see excellent results with 2–3 sessions spaced 4–6 weeks apart.' },
    ],
  },
