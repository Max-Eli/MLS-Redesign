...
export default function TermsPage() {
  return (
    <LegalPage eyebrow="Legal" title="Terms of Service" lastUpdated="July 31, 2026">
      <p>
      ...
      <h2>8. SMS/MMS Text Message Program</h2>
      <p>
        Manhattan Laser Spa operates two text-message programs, and you may opt in to either or both independently. Both programs are entirely voluntary, and consent to either is <strong>not a condition of purchase</strong>.
      </p>

      <h3>Appointment Notifications Program</h3>
      <p>
        Once you opt in, you agree to receive recurring automated SMS/MMS text messages from Manhattan Laser Spa related to your appointments, including confirmations, reminders, follow-up care, and treatment updates.
      </p>

      <h3>Marketing Program</h3>
      <p>
        Once you opt in, you agree to receive recurring automated SMS/MMS text messages from Manhattan Laser Spa promoting our services, including special offers, seasonal promotions, event invitations, and announcements of new treatments.
      </p>

      <h3>Program Terms Applicable to Both</h3>
      <ul>
        <li><strong>Message frequency:</strong> varies based on your activity with us.</li>
        <li><strong>Message and data rates:</strong> may apply from your mobile carrier. Manhattan Laser Spa does not charge for text messages; your standard rates apply.</li>
        <li><strong>Opt out:</strong> Reply <strong>STOP</strong> to any message from us at any time to be unsubscribed from that program. Once you send STOP, you'll receive one final confirmation message, and no further texts from that program.</li>
        <li><strong>Get help:</strong> Reply <strong>HELP</strong> at any time and we'll respond with contact information and support instructions.</li>
        <li><strong>Supported carriers:</strong> AT&amp;T, T-Mobile, Verizon Wireless, Sprint, Boost, U.S. Cellular, MetroPCS, and most other U.S. mobile carriers. Carriers are not liable for delayed or undelivered messages.</li>
        <li><strong>Compatible devices:</strong> our messages will display correctly on any standard mobile device capable of receiving SMS/MMS.</li>
        <li><strong>Privacy:</strong> we do not sell, share, or rent your phone number or SMS opt-in data to third parties for their own marketing purposes. Full details in our{' '}
          <Link href="/privacy">Privacy Policy</Link>.</li>
      </ul>
      <p>
        If you have questions about our text-message programs, contact us at{' '}
        <a href="mailto:florida@manhattanlaserspa.com">florida@manhattanlaserspa.com</a>
        {' '}or <a href="tel:+13057053997">305-705-3997</a>.
      </p>
