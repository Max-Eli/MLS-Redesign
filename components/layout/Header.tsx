...
const services = [
  {
    ...
    items: [
      ...
      { label: 'Carbon Laser Facial', href: '/services/carbon-laser-facial' },
      { label: 'Laser Tattoo Removal', href: '/services/laser-tattoo-removal' },
    ],
  },
  {
    ...
    items: [
      ...
      { label: 'VelaShape III', href: '/services/velashape' },
    ],
  },
  {
    label: 'Injectables',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Ultherapy', href: '/services/ultherapy' },
    ],
  },
  {
    label: 'Wellness',
