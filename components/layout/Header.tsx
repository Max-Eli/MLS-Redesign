...
const services = [
  {
    ...
    items: [
      { label: 'Small Areas',        href: '/treatments/laser-hair-removal' },
      { label: 'Medium Areas',       href: '/treatments/laser-hair-removal' },
      { label: 'Large Areas',        href: '/treatments/laser-hair-removal' },
      { label: 'Full Body Package',  href: '/treatments/laser-hair-removal' },
      { label: 'View All',           href: '/treatments/laser-hair-removal' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'View All',           href: '/treatments/facial-treatments' },
    ],
  },
  {
    ...
    items: [
      ...
      { label: 'View All',           href: '/treatments/body-treatments' },
    ],
  },
  {
    label: 'Injectables',
    ...
    items: [
      ...
      { label: 'View All',           href: '/treatments/injectables' },
    ],
  },
  {
    ...
    items: [
      ...
      { label: 'Hair Restoration',   href: '/treatments/hair-restoration' },
      { label: 'Memberships',        href: '/treatments/memberships' },
      { label: 'Gift Cards',         href: '/treatments/gift-cards' },
    ],
  },
]
...
export function Header() {
  ...
  return (
    <header
      ...
      className={cn(
        'fixed left-0 right-0 z-50 transition-all duration-500 ease-luxury',
        scrolled || !isHome
