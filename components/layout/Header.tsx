...
const services = [
  {
    ...
    items: [
      { label: 'Small Areas',        href: '/services/laser-hair-removal' },
      { label: 'Medium Areas',       href: '/services/laser-hair-removal' },
      { label: 'Large Areas',        href: '/services/laser-hair-removal' },
      { label: 'Full Body Package',  href: '/services/laser-hair-removal' },
      { label: 'View All',           href: '/shop?category=laser-hair-removal' },
    ],
  },
  {
    label: 'Laser Skin Treatments',
    href: '/shop?category=laser-skin-treatments',
    items: [
      ...
      { label: 'View All',           href: '/shop?category=laser-skin-treatments' },
    ],
  },
  {
    label: 'Facial Treatments',
    href: '/shop?category=facial-treatments',
    items: [
      ...
      { label: 'View All',           href: '/shop?category=facial-treatments' },
    ],
  },
  {
    label: 'Body Treatments',
    href: '/shop?category=body-treatments',
    items: [
  ...
  {
    label: 'IV Wellness & More',
    href: '/shop?category=iv-wellness-therapy',
    items: [
      { label: 'IV Therapy',         href: '/services/iv-therapy' },
      { label: 'Hair Restoration',   href: '/shop?category=hair-restoration' },
      { label: 'Memberships',        href: '/shop?category=memberships' },
